#### Preamble ####
# Purpose: Cleans data for GSS related to respondent information
         # and surveys on financial topics
...
# [work_status] Last week were you working full time, part time,
...
# [marital] Are you currently married, widowed, divorced, separated,
...
# [social_class] Most people see themselves as belonging to a particular class.
...
# [social_class1] Most people see themselves as belonging to a particular class.
# Please tell me which social class you would say you belong to?
cleaned_respondent_info <-
  cleaned_respondent_info |>
...
# running this institution are concerned, would you say you have a great deal
...
# [financial_change] During the last few years, has your financial situation
# been getting better, worse, or has it stayed the same?
...
# [financial_compare] Compared with American families in general,
# would you say your family income is far below average, below average,
# average, above average, or far above average? (PROBE: Just your best guess.)
