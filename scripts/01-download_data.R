#### Preamble ####
# Purpose: Downloads and saves data from [UPDATE ..]
...
write_csv(
  ...
  file = here("inputs/data/large_files/raw_respondent_info.csv")
)
...
raw_finance_survey =
  raw_gss_data |>
  select (year,id,confinan,satfin,finalter,finrela,govfnaid)
