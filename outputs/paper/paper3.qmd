...
Specifically, we retrieved the following demographic data (TODO: explain these values)
...
For survey questions related to financial wellness, we retrieved the following data points (TODO: explain these values):
