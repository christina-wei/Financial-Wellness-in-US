...
-   calculating % ... over the year for graph

-   Looking into social class getting it over the years
...
survey_data_2021$financial_compare =
  factor(survey_data_2021$financial_compare,
         levels = c(
           "Far Below Average",
           "Below Average",
           "Average",
...
survey_data_2021$financial_change =
  factor(survey_data_2021$financial_change,
         levels = c(
           "Getting Worse",
           "Stayed the Same",
           "Getting Better"
...
survey_data_2016$financial_change =
  factor(survey_data_2016$financial_change,
         levels = c(
           "Getting Worse",
           "Stayed the Same",
           "Getting Better"
